...
export function HomeHero({ setPortfolio }: { setPortfolio: any }) {
      ...
      <Flex direction="row" alignItems="center" gap={20}>
        <Flex w="80%" direction="column" justify="space-between">
          ...
          <Text
            ...
            mt={4}
            transition=" 0.8s cubic-bezier(0.01, 1.69, 0.99, 0.94)"
            fontSize={fontSmall ? 25 : 40}
          >
            <b>{fontSmall ? "" : "A "}Fullstack Software Engineer</b>
          </Text>
          <Text className="animate__animated animate__fadeIn animate__delay-4s animate__slower" mt={4}>
          ...
          <Flex mt={4}>
            <Flex gap={4} className="animate__animated animate__fadeIn animate__delay-4s animate__slower">
              <Image src={github} alt="Github" width={35} height={35} />
              <Image src={linkedin} alt="Linkedin" width={35} height={35} />
            </Flex>
            <ViewPortfolioButton setPortfolio={setPortfolio} />
          </Flex>
        </Flex>
        <Flex
          w="80%"
